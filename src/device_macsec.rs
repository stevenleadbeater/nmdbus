// This code was autogenerated with `dbus-codegen-rust -c blocking --file target/nm-1.10.14/NetworkManager-1.10.14/introspection/org.freedesktop.NetworkManager.Device.Macsec.xml`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
#[derive(Debug)]
pub struct DeviceMacsecPropertiesChanged {
    pub properties: arg::PropMap,
}

impl arg::AppendAll for DeviceMacsecPropertiesChanged {
    fn append(&self, i: &mut arg::IterAppend) {
        arg::RefArg::append(&self.properties, i);
    }
}

impl arg::ReadAll for DeviceMacsecPropertiesChanged {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(DeviceMacsecPropertiesChanged {
            properties: i.read()?,
        })
    }
}

impl dbus::message::SignalArgs for DeviceMacsecPropertiesChanged {
